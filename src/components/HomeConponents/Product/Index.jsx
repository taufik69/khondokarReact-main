...
const Products = () => {
  ...
  function SamplePrevArrow2(props) {
    ...
    return (
      <div
        className="top-1/2 z-10 h-[40px] w-[40px] -translate-y-1/2 cursor-pointer rounded-full border-2 bg-primary_font_color shadow-xl sm:left-12 -md:left-30 lg:left-[1%] xl:left-[1%]  2xl:left-[-80px]"
        style={{
          display: "flex",
